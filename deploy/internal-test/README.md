...
>
> ⚠️ **必读**：[`docs/04-ICP备案风险提示.md`](docs/04-ICP备案风险提示.md) —— 合规红线与风险
> 📘 既有「正式上线（域名 + HTTPS + 备案）」规划见 [`../README.md`](../README.md) 与
> [`../../docs/前端上线-域名与HTTPS方案.md`](../../docs/前端上线-域名与HTTPS方案.md)。
> **两套方案不可混用**：本阶段的部署脚本**不会**生成任何 80/443、域名、证书配置。
...
| [`docs/04-ICP备案风险提示.md`](docs/04-ICP备案风险提示.md) | ⚠️ **合规红线、风险与红线清单** |
